...
class Newnav extends React.Component{
  ...
  count = () =>{
    axios.put('http://localhost:5000/Portfolio/count').catch(err => console.error(err))
  }

  adress=()=>{
    fetch('https://geolocation-db.com/json/8f12b5f0-2bc2-11eb-9444-076679b7aeb0')
    .then(res => res.json())
    .then(data =>axios.post("http://localhost:5000/Portfolio/addadress",data).catch(err => console.error(err)))
